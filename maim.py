...
# ============================================================
st.divider()
st.header("4. 기간 전체 일관객 TOP 10 영화")

# 영화별 기간 전체 일관객 합계와 10위권에 든 날짜 수 계산
movie_summary = (
    df.groupby("영화명")
    .agg(
        기간_일관객=("일관객", "sum"),
...
st.markdown("**이 그래프로 알 수 있는 것:**")
st.info("이 기간 동안 누적해서 가장 많은 관객을 모은 영화 10편과 각 영화가 10위권에 머문 날수를 비교할 수 있습니다.")
